...
def determine_device_from_mac_address(mac_address):
    _LOGGER.debug(
        "Attempting to determine device model class from MAC address: %s" % mac_address
    )
...
def determine_device_class_from_serial_number(serial_number):
    _LOGGER.debug(
        "Attempting to determine device model class from serial number: %s"
        % serial_number
    )
...
def determine_device_class_from_model_number(model_number):
    _LOGGER.debug(
        "Attempting to determine device model class from model number: %s"
        % model_number
    )
